...
def get_cfgs():
    ...
    command_cfg = {
        "num_commands": 3,
        "lin_vel_x_range": [0.0, 1.0],  # Allow it to learn to stand and accelerate
        "lin_vel_y_range": [-0.3, 0.3], # Allow it to learn minor strafing 
        "ang_vel_range": [-0.5, 0.5],   # Allow it to learn to turn
    }
...
"""
# training
python rl-training-genesis/locomotion/lite3/basic/lite3_train.py --backend gpu -v
"""
