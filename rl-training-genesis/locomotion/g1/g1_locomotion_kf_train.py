...
from g1_locomotion_kf_env import Go2Env
...
"""
# training
python rl-training-genesis/g1_locomotion_kf_train.py --backend gpu -v
python rl-training-genesis/g1_locomotion_kf_train.py --backend gpu
python rl-training-genesis/g1_locomotion_kf_train.py
"""
